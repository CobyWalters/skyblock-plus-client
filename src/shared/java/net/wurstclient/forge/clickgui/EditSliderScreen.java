...
public final class EditSliderScreen extends GuiScreen {
	...
	@Override
	public void initGui() {
		valueField = new GuiTextField(1, WMinecraft.getFontRenderer(), width / 2 - 100, 60, 200, 20);
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		drawCenteredString(WMinecraft.getFontRenderer(), slider.getName(), width / 2, 20, 0xffffff);
