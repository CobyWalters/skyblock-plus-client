...
public final class WEventFactory {
	...
	public static float getAmbientOcclusionLightValue(float f, IBlockState state) {
		WGetAmbientOcclusionLightValueEvent event = new WGetAmbientOcclusionLightValueEvent(state, f);
		MinecraftForge.EVENT_BUS.post(event);
	...
	public static boolean shouldSideBeRendered(boolean b, IBlockState state) {
		WShouldSideBeRenderedEvent event = new WShouldSideBeRenderedEvent(state, b);
		MinecraftForge.EVENT_BUS.post(event);
	...
	public static boolean cameraTransformViewBobbing() {
		return !MinecraftForge.EVENT_BUS.post(new WCameraTransformViewBobbingEvent());
	}
	
	public static void onGuiInventoryInit(List<GuiButton> buttonList) {
		MinecraftForge.EVENT_BUS.post(new WGuiInventoryButtonEvent.Init(buttonList));
	}
	
	public static void onGuiInventoryButtonPress(GuiButton button) {
		MinecraftForge.EVENT_BUS.post(new WGuiInventoryButtonEvent.Press(button));
	}
}
